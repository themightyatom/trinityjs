...
class DecorOrbitControls {
	...
	constructor(object, domElement) {
		...
		this.dispose = function () {
			...
			DD2022.eventManager.removeAllActions(scope);
			DD2022.eventManager.removeWheelActions(scope);
		...
		this.onPointerDown = function (event) {
			...
			if (pointers.length === 0) {
				...
				DD2022.eventManager.addAction({ type: "up", target: scope, func: "onPointerUp" });
		...
		this.onPointerUp = function (event) {
			...
			if (pointers.length === 0) {
				...
				//scope.domElement.removeEventListener('pointermove', scope.onPointerMove);
				DD2022.eventManager.removeAction({ type: "move", target: scope, func: "onPointerMove" });
				
				//scope.domElement.removeEventListener('pointerup', scope.onPointerUp);
				DD2022.eventManager.removeAction({ type: "up", target: scope, func: "onPointerUp" });
	...
	activate() {
		...
		DD2022.eventManager.addAction({ type: "down", target: scope, func: "onPointerDown" });
...
class MapControls extends DecorOrbitControls {
...
export { DecorOrbitControls, MapControls };

...
if(!ltvs__designid){
  ltvs__productid =  document.getElementById(ltvs__idelement).value;
}
let ltvs__modelid;
//const ltvs__launchDiv = document.createElement("div");
const ltvs__launchDiv = document.getElementById('ltvs_config');
...
function ltvs__createbutton(){
  ...
  ltvs__launchDiv.innerHTML = '<div class="ltvs-centering"><img src="' + ltvs__source + '/imgs/cube.gif"><span>DESIGN 3D</span></div>';
  ...
  let target_div = document.getElementsByClassName("product-form__controls-group")[0];
  ltvs__launchDiv.classList.add("ltvs-launcher");
  target_div.appendChild(ltvs__launchDiv);
...
ltvs__loadScript(ltvs__source + '/js/initDD2022.js')
